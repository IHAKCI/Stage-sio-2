# 📔 Journal de Bord - Stage Association CAFAF

## 📋 Informations Générales

- **Dates :** Du 16/02/2026 au 10/04/2026
- **Tuteur :** Najib Gasmi
- **Poste :** Stagiaire Informatique (systèmes & réseau)
...
-  Liste des acquis/besoins :
    ...
    - Imprimante
    - Caméra avec NVR
    - NAS (appartenant à la bureautique et isolé)
    - PC (Mac, Windows, etc)
    - Wifi isolé
    - Switch (Netgear)
...
- Implémentation de l'applicatif Brother pour les responsables pour fluidifier les impressions ( Assistance utilisateurs)
